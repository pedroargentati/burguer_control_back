...
public class EventController extends RestCommonService {
    ...
    @GetMapping
    public ResponseEntity<Page<EventDTO>> getEvents(@PageableDefault(size = 15) Pageable pageable) {
        return super.buildDefaultResponseForPage(eventService.getEvents(pageable));
    }
    ...
    public ResponseEntity<EventDTO> deleteEvent(@PathVariable Long id) throws RecordNotFoundException {
        ...
        return super.buildResponseForDelete(event);
    }
